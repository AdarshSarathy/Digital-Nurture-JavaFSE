public class SearchTest {
    public static void main(String[] args) {
        ...
        Product[] catalogue = {
            ...
            new Product(106, "Desk Lamp",         "Furniture"),
            new Product(107, "Notebook",          "Stationery"),
            new Product(108, "Water Bottle",      "Fitness"),
        };
        Product[] sortedCatalogue = SearchAlgorithms.sortByName(catalogue);
        System.out.println("--- Linear Search (unsorted array) ---");
        Product r1 = SearchAlgorithms.linearSearchByName(catalogue, "Yoga Mat");
        ...
        System.out.println();
        Product r3 = SearchAlgorithms.binarySearchByName(sortedCatalogue, "Yoga Mat");
